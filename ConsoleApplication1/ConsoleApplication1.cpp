...
////--------------------------------------------------------26
    // Удаление из массива простых чисел
...
//printf("%d", s);
////--------------------------------------------------------41
//Нахождение суммы первых положительных элементов массива до отрицательного
...
//printf("%d", s);
////--------------------------------------------------------42
//Нахождение такого индекса массива, при котором сумма элементов слева и справа будет примерно равна
...
//printf("%d ", s);
////--------------------------------------------------------44
//Сортировка выборкой, которая записывается в массив B
//for (j = 0; n != 0; j++) {
//    for (k = 0, i = 1; i < n; i++)
//        if (A[i] < A[k]) k = i;
//    B[j] = A[k];
